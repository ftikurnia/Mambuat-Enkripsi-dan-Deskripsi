...
<head>
  <title>Enkripsi Tugas Pak Syarif</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  ...
  <link href="gambar/3.jpeg.jpg" rel="icon">
</head>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="be/login.php">LOGOUT</a></li>
        </ul>
      </div>
    </div>
  </nav>
